  ...
  return (
    ...
    (
        <>
            ...
            <section className='py-4 grid gap-y-4 gap-x-8 grid-cols-3'>
                {
                    userPlaylists.items.map((playlist) => {
                        return(
                            <Link href={`/playlist/${playlist.id}`} key={playlist.id} className='flex flex-col gap-2 bg-highlight py-4 px-6 m-auto rounded-lg w-[200px] hover:bg-selectedLink'>
